...
function Calculator() {
  ...
  return (
    <div className=" w-full  h-full    bg-[#8f90a0] ">
      <div className="   lg:md:w-[730px] xl:w-[866px]  w-[324px] h-[729px] lg:md:h-[651px]  absolute lg:md:top-[1627px] top-[1450px] left-[30px]  lg:md:left-[150px] sm:left-[170px] xl:left-[290px] 2xl:left-[190px]  lg:md:-z-20 sm:right-[60px] right-[-10px] mx-auto sm:-z-20 ">
        <div className="  lg:md:w-[730px] xl:w-[866px] lg:md:h-[559px] absolute  top-[91px] gap-[50px] flex flex-col ">
          <div className=" lg:md:w-[730px] xl:w-[866px] lg:md:h-[455px] gap-[120px]  flex  ">
            <div className=" lg:md:w-[572px] lg:md:h-[455px]  ">
              ...
              <div className="   sm:w-[562px] w-[324.2px] lg:md:h-[43px] h-[39.92px] absolute lg:md:top-[49px] top-[20px] rounded-[8.87px] border-[1.11px] border-[#969699] flex justify-around items-center">
              ...
              <div className=" lg:md:w-[524.14px] w-[313.88px] lg:md:h-[40px] h-[300px] absolute lg:md:top-[200px] lg:md:mt-[-140px] top-[90px] ">
                ...
                <div className="  lg:mt-8 mt-5 md:mt-12">
                ...
                <div className=" lg:mt-8 mt-5 md:mt-1">
                  <Slider1 max={100} step={1} />
                </div>
              </div>
            </div>
            <div className=" flex lg:md:flex-col absolute left-[20px] lg:md:left-[550px] xl:left-[660px] top-[490.2px] lg:top-[1.2px] md:top-[600px] lg:md:mt-[130px] lg:md:gap-[10px] gap-[40px] lg:md:w-[174px] lg:md:h-[283px] w-[295px] h-[72px] ">
              {" "}
          ...
          <div className=" lg:md:w-[125px] w-[108px] lg:md:h-[54px] h-[43px] lg:md:rounded-[18px] rounded-[12px] bg-[#4A508E] lg:md:pt-[16px] pt-[12px] lg:md:pr-[24px] pr-[20px] lg:md:pb-[12px] pb-[16px] lg:md:pl-[24px] pl-[20px] absolute top-[420px] left-[105px] lg:top-[551px] md:top-[690px] lg:md:left-[358px] lg:md:mx-auto cursor-pointer mb-[20px] hover:scale-[1.2] transition duration-[0.7s] ease-in-out ">
            <div
