...
function dasboard() {
  return (
    ...
    <div className=' md:w-full sm:w-[900px] w-[385px] '>
      <div className=' absolute -z-20 lg:w-full md:w-[1024px] w-[105%] sm:w-[910px] top-[-50px] lg:h-[1024px]  '>
      ...
      <div className='sm:w-[28%] xl:w-[28%]  w-[300px] sm:h-[630px] h-[450px] absolute sm:top-[126px]  top-[300px]   lg:md:left-[730px] xl:left-[850px] 2xl:left-[1200px] left-[-70px] -z-20 ' >
         <Image src={heroimage} alt='Mobile' className=' absolute left-[105px] md:left-[730px] lg:left-[20px] xl:left-[105px] sm:left-[750px]  shadow-[rgba(0,0,0,0.2)]' width={420} height={630} />
      </div>
