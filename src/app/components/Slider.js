  ...
  return (
    <div className="slider-container flex flex-col">
      ...
      <input 
        ...
        className="slider  sm:w-[400px] sm:h-full w-[300px] h-[7.5px] accent-[#4A508E] " 
      />
      {/* Display slider value */}
      <div className="slider-value  font-sans font-semibold  w-[72px] h-[41px] absolute top-[100px] left-[120.8px] bottom-[2px] md:top-[225px] sm:top-[80px] rounded-[15px] border-b-[2px] border-[#4A508E] ">
