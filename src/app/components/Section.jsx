...
function Section() {
  ...
  return (
    <div className='  lg:w-full md:w-[1024px]  w-[100%] sm:w-[875px]  sm:h-[924px] h-[571px] absolute top-[750px] lg:top-[600px] md:top-[440px] sm:top-[390px] p-[40px] bg-[#4A508E] z-[25] mr-[20px]'>
      <div className=' md:w-[990px] sm:w-[800px]  xl:w-full w-[360px] sm:h-[644px] h-[571px] gap-[50px] flex flex-col sm:mx-auto sm:ml-0 ml-[-41px]'>
        ...
        <div>
          <div className='absolute top-[110px]  right-[50px] left-[50px] w-[300px] h-[129px] pt-[0px] pl-[16px] pr-[0px] pb-[16px] flex flex-col mx-auto justify-between '>
